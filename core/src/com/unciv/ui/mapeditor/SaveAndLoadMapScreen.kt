...
class SaveAndLoadMapScreen(mapToSave: TileMap?, save:Boolean = false, previousScreen: CameraStageBaseScreen)
    ...
    init {
        ...
        if (save) {
            ...
            keyPressDispatcher[KeyCharAndCode.translate("Ctrl-C")] = copyMapAsTextAction
            ...
            keyPressDispatcher[KeyCharAndCode.translate("Ctrl-V")] = loadFromClipboardAction
        ...
        keyPressDispatcher[KeyCharAndCode.translate("DEL")] = deleteAction
