...
internal class ModInfoAndActionPane : Table() {
    private val imageHolder = ModPreviewImageHolder(ModManagementScreen.maxAllowedPreviewImageSize, { it == currentRepoName })
    ...
    private fun update(
        ...
        imageHolder.showPreview(modName, isBuiltin, isLocal, repoUrl, defaultBranch, avatarUrl)
        add(imageHolder).row()
