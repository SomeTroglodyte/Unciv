...
class ClassicCityScreen(
    ...
    override var selectedConstruction: IConstruction? = initSelectedConstruction
        private set
    ...
    override fun askToBuyTile(selectedTile: Tile) = askToBuyTile(this, selectedTile) {
        ...
        UncivGame.Current.replaceCurrentScreen(ClassicCityScreen(city, initSelectedTile = city.expansion.chooseNewTileToOwn()))
    }
    ...
    override fun clearSelection() = selectTile(null)
